function CRep = CRepClassifRepDict(allP)
% CRepClassifRepDict - factor for is desirability to report what one wants to.
%   This fn. applies equally to reporting factors in their corresponding mini-mdps.
