function fairRep_d = hub2spoke_dFair(hub_a1, hub_d, allP )
% function mdpFairRep = hub2spoke_AFairRep(mdpFairRep,hub_a1, allP )
%          Estimate the A map for reporting expected fairness, based on the
