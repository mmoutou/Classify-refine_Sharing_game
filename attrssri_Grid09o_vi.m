function optPar = attrssri_Grid09o_vi( block, wave, startFitFile, grN, grSc, blocksize, codeTest)
%  optPar = attrssribGrid09o_vi( block, wave) :  MAP fitting, with weakly informative priors given by 
% attrssriaGrid09o_vi_**  MAP fitting with weakly informative priors given by 
%                        scaled beta distributions. ssria means the first wave, and 09o means
...
%                        and settig (transf) wS to the median of prev. best fit wS_med_k = 0.34004
...
for ptN = todo
    ptCnt = ptCnt+1; 
    % In 09o, no wS, which is 9 : 
    parOrdGrid = [1 2 8 3 5 11 4 6 7 10 1 2 8 3 5 7 6 4 1 2 11];  % in order above in hd. Cycle twice!
