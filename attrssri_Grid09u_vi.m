function optPar = attrssri_Grid09u_vi( block, wave, startFitFile, grN, grSc, blocksize, codeTest )
%  optPar = attrssribGrid09u_vi( block, wave) :  MAP fitting, with weakly informative priors given by 
% attrssriaGrid09u_vi_**  MAP fitting, with weakly informative priors given by 
%                        scaled beta distributions. ssria means the first wave, and 09u means
%                        that it's the 09 version of the generative function, u for 
...
fitStr = '09u'; % short string to identify the fitting version in outputs / filenames
...
for ptN = todo
    ptCnt = ptCnt+1; 
    % In 09o, no pocB (12) nor initEvRat (5) : 
